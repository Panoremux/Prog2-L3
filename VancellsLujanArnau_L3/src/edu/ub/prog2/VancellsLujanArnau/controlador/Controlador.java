...
public class Controlador implements InControlador{
    ...
    public Controlador(){
        dades=new Dades();
        //reproductor = new ReproductorVisor("C:/Program Files/VideoLAN/VLC");
    ...
    @Override
    public void afegirImatge(String string, String string1, int i, int i1) throws AplicacioException {
    ...
    @Override
    public void mostrarFitxer(int i, int i1) throws AplicacioException {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
